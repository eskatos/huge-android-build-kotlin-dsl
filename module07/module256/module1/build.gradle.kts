...
dependencies {
  ...
  androidTestImplementation(project(":module07:module256:module5"))
  ...
  implementation(project(":module07:module256:module2"))
  implementation(project(":module07:module256:module3"))
