...
dependencies {
  ...
  androidTestImplementation(project(":module07:module513:module3"))
  ...
  implementation(project(":module07:module478:module3"))
  implementation(project(":module07:module513:module2"))
